...
conditions_sudoku = au_moins_un_cfr()+au_plus_un_cfr()+r_ts_cfr()+c_ts_cfr()+box_ts_cfr()+diag_pr_au_moins_un_cfr()+diag_sc_au_moins_un_cfr()+diag_pr_au_plus_un_cfr()+diag_sc_au_plus_un_cfr()
